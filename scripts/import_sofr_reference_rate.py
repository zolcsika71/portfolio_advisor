"""Deterministically import retained NY Fed SOFR evidence into an explicit target."""
...
from portfolio_advisor.reference_rates.sofr import SofrError, import_sofr_evidence
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"SOFR offline import failed: {error}", file=sys.stderr)
        return 2
