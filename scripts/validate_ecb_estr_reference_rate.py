"""Read-only deterministic validation of admitted official ECB €STR evidence."""
...
from portfolio_advisor.reference_rates import EcbEstrError, validate_ecb_estr_database
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        result = validate_ecb_estr_database(
        ...
        print(f"ECB €STR validation failed: {error}", file=sys.stderr)
        return 2
