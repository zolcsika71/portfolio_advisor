"""Deterministically import retained ECB €STR evidence into an explicit database target."""
...
from portfolio_advisor.reference_rates import EcbEstrError, import_ecb_estr_evidence
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        result = import_ecb_estr_evidence(
    ...
    except (ConstructionPolicyValidationError, EcbEstrError, OSError, ValueError) as error:
        print(f"ECB €STR offline import failed: {error}", file=sys.stderr)
        return 2
