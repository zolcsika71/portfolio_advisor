"""Read-only validation of retained and installed official MNB HUFONIA evidence."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        result = validate_hufonia_database(
        ...
        print(f"HUFONIA validation failed: {error}", file=sys.stderr)
        return 2
