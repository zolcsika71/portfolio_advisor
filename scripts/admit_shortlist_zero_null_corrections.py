"""Admit the authorized shortlist numeric-zero-to-NULL correction set."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        result = admit_zero_null_corrections(
            arguments.database,
            CorrectionRequest(
    ...
    except (OSError, ShortlistCorrectionError, ValueError) as error:
        print(f"Shortlist correction admission failed: {error}", file=sys.stderr)
        return 2
    print(
        json.dumps(
            {
