"""Build a disposable provenance-v2 database candidate with official SOFR evidence."""
...
from portfolio_advisor.database.migrations.sofr import build_sofr_evidence_candidate
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"SOFR candidate build failed: {error}", file=sys.stderr)
        return 2
